import{ag as p,ap as x}from"./index-ec3k2M-Q.js";import{u as c}from"./index-BgXfHays.js";import"./iframe-SLIV7eNo.js";import"../sb-preview/runtime.js";import"./index-C8d-gAZN.js";import"./index-D-8MO0q_.js";import"./index-DrFu-skq.js";var h={exports:{}},a={};/**
 * @license React
...
interactive reference documentation from your components and stories.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/writing-docs/autodocs/?renderer=vue",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:B,alt:"A browser window showing a Storybook being published to a chromatic.com URL"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Publish to Chromatic"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Publish your Storybook to review and collaborate with your entire team."}),e.jsxs("a",{href:"https://storybook.js.org/docs/sharing/publish-storybook/?renderer=vue#publish-storybook-with-chromatic",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:U,alt:"Windows showing the Storybook plugin in Figma"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Figma Plugin"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Embed your stories into Figma to cross-reference the design and live
implementation in one place.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/sharing/design-integrations/?renderer=vue#embed-storybook-in-figma-with-the-plugin",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:F,alt:"Screenshot of tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Testing"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Use stories to test a component in all its variations, no matter how
complex.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/writing-tests/?renderer=vue",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:L,alt:"Screenshot of accessibility tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Accessibility"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Automatically test your components for a11y issues as you develop."}),e.jsxs("a",{href:"https://storybook.js.org/docs/writing-tests/accessibility-testing/?renderer=vue",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:S,alt:"Screenshot of Storybook in light and dark mode"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Theming"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Theme Storybook's UI to personalize it to your project."}),e.jsxs("a",{href:"https://storybook.js.org/docs/configure/theming/?renderer=vue",target:"_blank",children:["Learn more",e.jsx(t,{})]})]})]})})]}),`
`,e.jsxs("div",{className:"sb-addon",children:[e.jsxs("div",{className:"sb-addon-text",children:[e.jsx("h4",{children:"Addons"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Integrate your tools with Storybook to connect workflows."}),e.jsxs("a",{href:"https://storybook.js.org/addons/",target:"_blank",children:["Discover all addons",e.jsx(t,{})]})]}),e.jsx("div",{className:"sb-addon-img",children:e.jsx("img",{src:Q,alt:"Integrate your tools with Storybook to connect workflows."})})]}),`
